...
jsonschema = coreschema.RefSpace({
    'Schema': coreschema.Object(
        properties={
            ...
            # Type
            'type': coreschema.Ref('SimpleTypes') | coreschema.Array(items=coreschema.Ref('SimpleTypes'), min_items=1,
                                                                     unique_items=True),
            # Number validators
            ...
            'dependancies': coreschema.Object(
                additional_properties=coreschema.Ref('Schema') | coreschema.Ref('StringArray')),
            # Enum validators
